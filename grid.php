...
<h1 class="border-b-xs p-b-05-xs m-b-4-xs">Grid</h1>

<section id="grid">
  <h2 class="m-b-1-xs">The Grid</h2>
...
&lt;/div&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs">Grid Max-Width</h2>
  <p class="m-b-1-xs">By default, our grid will span 100% of the browser viewport. If you want to control that, add <code>.col-max</code> next to your <code>.col-container</code> class. This will limit the width of the grid to <code>1200px</code>.</p>
  <div class="col-container col-max">
    <div class="border-dark-xs p-2-xs">1200px max-width</div>
  </div>
  <div class="guide-code m-b-4-xs">
...
&lt;/div&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs">Nesting Columns</h2>
...
&lt;/div&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs">Centering Columns</h2>
...
&lt;/div&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs">Column Offsets</h2>
...
&lt;/div&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs">Responsive Breakpoint Classes</h2>
