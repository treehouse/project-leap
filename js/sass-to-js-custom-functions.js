...
// Apply automation to elements in the Guide
var popColors = function(elementId, $elementId, guideClass) {
  ...
  for (var colorClass in colorJSON) {
    ...
    // Create span to hold color
    var colorSpan = document.createElement('span');
    colorSpan.className = 'p-2-xs m-lr-1-xs block-xs round pop-bg-' + colorClass;
...
popColors('popColorData', '#popColorData', '.guide-colors-pop');
