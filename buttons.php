...
<h1 class="border-b-xs p-b-05-xs m-b-4-xs">Buttons</h1>

<section id="Buttons">
  <h2 class="m-b-1-xs" id="default">Default</h2>
...
<pre><code class="language-html">&lt;a class="m-b-05-xs button button--large-xs" href&gt;Large&lt;/a&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs" id="primary">Primary</h2>
...
&lt;a class="m-b-05-xs button button--primary button--xsmall-xs" href&gt;X-Small&lt;/a&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs" id="secondary">Secondary</h2>
...
&lt;a class="m-b-05-xs button button--secondary button--xsmall-xs" href&gt;X-Small&lt;/a&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs" id="alert">Alert</h2>
...
&lt;a class="m-b-05-xs button alert button--xsmall-xs" href&gt;X-Small&lt;/a&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs" id="inverse">Inverse</h2>
  <p class="m-b-3-xs">Inverse buttons are used when the background color a container is too dark for normal buttons to have enough contrast. Invert the style of any button (to white) with the class, <code>.button.button--inverse</code>.</p>
  <div class="bg-gray-darker p-2-xs">
    <a class="m-b-05-xs button button--inverse button--large-xs" href>Large</a>
    <a class="m-b-05-xs button button--inverse" href>Normal</a>
    <a class="m-b-05-xs button button--inverse button--small-xs" href>Small</a>
    <a class="m-b-05-xs button button--inverse button--xsmall-xs" href>X-Small</a>
  </div>
  <div class="guide-code m-b-4-xs">
<pre><code class="language-html">&lt;a class="m-b-05-xs button button--inverse button--large-xs" href&gt;Large&lt;/a&gt;
&lt;a class="m-b-05-xs button button--inverse" href&gt;Normal&lt;/a&gt;
&lt;a class="m-b-05-xs button button--inverse button--small-xs" href&gt;Small&lt;/a&gt;
&lt;a class="m-b-05-xs button button--inverse button--xsmall-xs" href&gt;X-Small&lt;/a&gt;</code></pre>
  </div>



  <h2 class="m-b-1-xs" id="disabled">Disabled</h2>
...
&lt;a class="m-b-05-xs button button--disabled button--xsmall-xs" href&gt;X-Small&lt;/a&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs" id="disabled">Extra Large Buttons</h2>
  ...
  <a class="m-b-05-xs button button--xlarge" href>Default</a>
  <a class="m-b-05-xs button button--primary button--xlarge" href>Primary</a>
  <a class="m-b-05-xs button button--secondary button--xlarge" href>Secondary</a>
  <a class="m-b-05-xs button button--alert button--xlarge" href>Alert</a>
  <a class="m-b-05-xs button button--disabled button--xlarge" href>Disabled</a>
  <div class="guide-code m-b-4-xs">
<pre><code class="language-html">&lt;a class="m-b-05-xs button button--xlarge" href&gt;Default&lt;/a&gt;
&lt;a class="m-b-05-xs button button--primary button--xlarge" href&gt;Primary&lt;/a&gt;
&lt;a class="m-b-05-xs button button--secondary button--xlarge" href&gt;Secondary&lt;/a&gt;
&lt;a class="m-b-05-xs button button--alert button--xlarge" href&gt;Alert&lt;/a&gt;
&lt;a class="m-b-05-xs button button--disabled button--xlarge" href&gt;Disabled&lt;/a&gt;</code></pre>
  </div>



  <h2 class="m-b-1-xs" id="topic-color-button">Topic Color Buttons</h2>
...
&lt;/div&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs" id="disabled">Full Width</h2>
...
&lt;a class="m-b-05-xs button w-full-xs w-auto-lg button--alert m-b-05-xs" href&gt;Button&lt;/a&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs" id="disabled">Pill Buttons (Tags)</h2>
...
&lt;a class="m-b-05-xs button circle button--alert m-b-05-xs" href&gt;Button&lt;/a&gt;</code></pre>
  ...
  <h2 class="m-b-1-xs" id="split-buttons">Split Buttons</h2>
